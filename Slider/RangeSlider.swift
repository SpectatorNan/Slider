...
class RangeSlider: UIControl {
    ...
    override func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        if lowerThumbLayer.frame.contains(previousLocation) {
            lowerThumbLayer.hightlighted = true
        } else if upperThumbLayer.frame.contains(previousLocation) {
            upperThumbLayer.hightlighted = true
        }
        
        return lowerThumbLayer.hightlighted || upperThumbLayer.hightlighted
    }
    ...
    override func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        if lowerThumbLayer.hightlighted {
            lowerValue += deltaValue
            lowerValue = boundValue(value: lowerValue, toLowerValue: minimumValue, upperValue: upperValue)
        } else if upperThumbLayer.hightlighted {
    ...
    override func endTracking(_ touch: UITouch?, with event: UIEvent?) {
        lowerThumbLayer.hightlighted = false
        upperThumbLayer.hightlighted = false
    }
